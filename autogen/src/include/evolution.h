...
const u8 gEvolutionMethodNames[EVO_METHOD_COUNT][EVO_LENGTH + 1] =
{
    [EVO_FRIENDSHIP      ] = _("Happiness"),
    [EVO_FRIENDSHIP_DAY  ] = _("HappinessDay"),
    [EVO_FRIENDSHIP_NIGHT] = _("HappinessNight"),
    [EVO_LEVEL           ] = _("Level"),
    [EVO_TRADE           ] = _("Trade"),
    [EVO_TRADE_ITEM      ] = _("HoldItem"),
    [EVO_ITEM            ] = _("Item"),
    [EVO_LEVEL_ATK_GT_DEF] = _("AttackGreater"),
    [EVO_LEVEL_ATK_EQ_DEF] = _("AtkDefEqual"),
    [EVO_LEVEL_ATK_LT_DEF] = _("DefenseGreater"),
    [EVO_LEVEL_SILCOON   ] = _("Level"),
    [EVO_LEVEL_CASCOON   ] = _("Level"),
    [EVO_LEVEL_NINJASK   ] = _("Ninjask"),
    [EVO_LEVEL_SHEDINJA  ] = _("Shedinja"),
    [EVO_BEAUTY          ] = _("Beauty"),
    [EVO_RENAME          ] = _("Rename"),
};
...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GROUDON]    = {{EVO_RENAME, 0, SPECIES_GRAVELER}},

};

const u8 gEvolutionRenameTable[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = 
{
    [SPECIES_GRAVELER] = _("EMET"),
    [SPECIES_GROUDON] = _("MET"),
