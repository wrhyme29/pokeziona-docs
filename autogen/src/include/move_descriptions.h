...
static const u8 sLowKickDescription[] = _(
    "A kick that inflicts more damage on heavier foes.");
...
static const u8 sFireBlastDescription[] = _(
    "Incinerates everything it strikes. May cause a burn.");
...
static const u8 sScaryFaceDescription[] = _(
    "Frightens with a scary face to sharply reduce SPEED.");
...
static const u8 sSleepTalkDescription[] = _(
    "Uses an available move randomly while asleep.");
...
static const u8 sSnatchDescription[] = _(
    "Steals the effects of the move the target uses next.");
