...
#define CATEGORY_LENGTH 9

const u8 gCategoryNames[MOVE_CATEGORY_COUNT][CATEGORY_LENGTH + 1] =
{
    [MOVE_CATEGORY_PHYSICAL] = _("PHYSICAL"),
    [MOVE_CATEGORY_SPECIAL] = _("SPECIAL"),
    [MOVE_CATEGORY_STATUS] = _("STATUS"),
};
